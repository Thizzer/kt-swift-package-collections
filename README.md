...
```gradle
implementation group: 'com.thizzer.kt-swift-package-collections', name: 'kt-swift-package-collections', version: '1.0.2'
```

#### Kotlin

```kotlin
implementation("com.thizzer.kt-swift-package-collections:kt-swift-package-collections:1.0.2")
```
